...
const NewsArticles = () => {
  return (
    <div className="px-4 md:px-10 py-16 bg-white">
      <h2 className="text-4xl mb-3 font-bold text-center">Latest News</h2>
      <p className="text-center mb-10 text-xl">Stay informed with the latest industry trends, company updates,<br/> 
      and expert insights from Silverline Rental.</p>
      <div className="grid gap-6 md:grid-cols-3">
        {Newsarticle.map((news, index) => (
          <motion.div
          key={index}
